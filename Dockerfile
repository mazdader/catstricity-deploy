...
RUN apt-get update \
	&& apt-get install -y --no-install-recommends python2.7 python-pip python2.7-setuptools gcc gettext mysql-client libmysqlclient-dev postgresql-client libpq-dev sqlite3 \
